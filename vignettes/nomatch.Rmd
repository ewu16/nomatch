...
Effect measures such as risk differences, risk ratios, and vaccine effectiveness are also provided. 
...
We can print the vaccine effectiveness estimates for our simulated dataset. 
...
The simultaneous confidence interals are now stored in the fitted object.  
```{r}
fit_with_simul
```
