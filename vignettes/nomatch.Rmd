...
- `immune_lag, eval_times`: Arguments that specify what cumulative incidences to compute. The first, `immune_lag`,
...
to the setting of interest. The second, `eval_times`, specifies the timepoints of interest
